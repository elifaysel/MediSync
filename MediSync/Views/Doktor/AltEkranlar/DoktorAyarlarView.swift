...
struct DoktorAyarlarView: View {
        ...
        NavigationStack {
            Form {
                Section("Kullanıcı Adı") {
                    ...
                    .disabled(yeniKullaniciAdi.isEmpty || yeniKullaniciAdi == doktor.kullaniciAdi)
                }
            ...
            .onAppear {
                yeniKullaniciAdi = doktor.kullaniciAdi
            }
        }
    }
    ...
    func kullaniciAdiGuncelle() {
        ...
        let kaVarHasta = hastalar.contains { $0.kullaniciAdi == yeniKullaniciAdi }
        let kaVarDoktor = doktorlar.contains { $0.kullaniciAdi == yeniKullaniciAdi && $0.kullaniciAdi != doktor.kullaniciAdi }
        ...
        doktor.kullaniciAdi = yeniKullaniciAdi
...
#Preview {
    DoktorAyarlarView(doktor: Doktor(ad: "Test", soyad: "Doktor", tcKimlikNo: "1", kullaniciAdi: "test", sifre: "1234", poliklinik: nil, hastane: nil))
        .modelContainer(for: [Doktor.self, Hasta.self], inMemory: true)
}
